 ...
 * 填充图形
 */
public class ShaderImageActivity extends Activity implements OnClickListener{
    // 声明位图渲染对象
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.shader_image);
        myView = (MyView2)findViewById(R.id.my_view);
        // 获得Bitmap实例
        ...
        // 实例化RadialGradient
        shaders[2] = new RadialGradient(400, 400, 80, colors, null,
                TileMode.REPEAT);
        // 实例化SweepGradient
        shaders[3] = new SweepGradient(560, 460, colors, null);
        // 实例化ComposeShader
