 ...
 * 数据库查询操作
 */
public class SqlLiteInsertActivity extends Activity{
            ...
            , String title, String content)  // ②
    {
        ...
        cValue.put("news_title",title);
        cValue.put("news_content",content);
        db.insert("news_inf",null,cValue);
    }
    private void inflateList(Cursor cursor)
    {
        // 填充SimpleCursorAdapter
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                SqlLiteInsertActivity.this,
